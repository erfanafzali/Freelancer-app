    ...
    <div>
      {onOpen && (
        <div className="backdrop-blur-sm fixed top-0 left-0 w-full h-screen bg-opacity-30 bg-secondary-800 z-50">
          <div
            ref={ref}
            className="fixed top-[44%] left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-secondary-0 p-4 shadow-lg transition-all duration-500 ease-out w-80 sm:w-[400px] md:w-[500px] lg:w-[650px]"
          >
